...
# Robonect command orchestration
TARGETED_WAKEUP_HOUR = 9
TARGETED_WAKEUP_MINUTE = 0
MORNING_AUTO_WAIT_SECONDS = 15
MORNING_START_WAIT_SECONDS = 10
ROBOT_COMMAND_GAP_SECONDS = 2
AUTO_RESET_LATCH_MINUTES = 2
AUTO_RESET_STEP_DELAY_SECONDS = 10
MOWER_DATA_STALE_MINUTES = 60
LATE_START_CHECK_HOUR = 11
LATE_START_CHECK_MINUTE = 5
LATE_START_WINDOW_MINUTES = 10
LATE_START_AUTO_WAIT_SECONDS = 10
LATE_START_ROBOT_GAP_SECONDS = 10
...
DEFAULT_CALENDAR_EVENT_START_TIME = "12:20"
